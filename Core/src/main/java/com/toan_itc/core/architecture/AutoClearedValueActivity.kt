 ...
 */
class AutoClearedValueActivity<T : Any>(val fragment: FragmentActivity) : ReadWriteProperty<FragmentActivity, T> {
 ...
 */
fun <T : Any> FragmentActivity.autoCleared() = AutoClearedValueActivity<T>(this)
